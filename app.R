...
ui <- fluidPage(
	...
	fluidRow(
		column(12,
					 p("Hello and welcome to the kinase inhibitor cell viability prediction web server. This website is a companion 
					 ...
					 p("This model is built to work with human cell line RNAseq data and makes cell viability predictions for 229 kinase 
